...
class SkillSelector:
    ...
    SKILL_TRIGGERS: dict[str, list[str]] = {
        "finance": [
            # 财务相关
            "费用", "分摊", "预算", "实际", "对比",
            "fy", "财年", "year", "scenario", "budget", "actual",
            "allocation", "分摊给", "allocated to",
            "it费用", "hr费用", "cost", "amount",
            "ct", "xp", "业务线", "成本中心", "cc",
            "insightbot", "ssme",
        ],
        "code-review": [
            "review", "代码审查", "code review", "审查",
            "重构", "refactor", "优化代码", "改进代码",
        ],
        "agent-builder": [
            "agent", "智能体", "create agent", "创建agent",
            "build agent", "agent框架",
        ],
        "skill-creator": [
            "create skill", "创建技能", "skill", "技能",
            "package skill", "打包技能",
        ],
        "pdf": [
            "pdf", "pdf处理", "pdf转换", "pdf提取",
        ],
        "deep-agents-core": [
            "deep agent", "todo", "middleware", "langgraph",
        ],
        "langchain-fundamentals": [
            "langchain", "create_agent", "@tool", "tool()",
        ],
        "langgraph-fundamentals": [
            "langgraph", "stategraph", "workflow",
        ],
        "langchain-rag": [
            "rag", "retrieval", "embedding", "vector", "chroma",
        ],
        "mcp-builder": [
