...
from backend.domain.models.events.base import ToolCallCompleted, ToolCallFailed, ToolCallStarted
...
class ToolManager:
    ...
    def register(
        self, name: str, handler: Callable, description: str, parameters: JSONSchema | None = None
    ):
        """
        注册工具
    ...
    async def execute(self, dialog_id: str, tool_call: ToolCall) -> str:
        """
        执行工具调用
