...
class TokenUsage(BaseModel):
    ...
    """
    input_tokens: Optional[int] = Field(None, description="输入 token 数量")
    output_tokens: Optional[int] = Field(None, description="输出 token 数量")
...
class UnifiedLLMResponse(BaseModel):
    ...
    reasoning_content: Optional[str] = Field(None, description="思考过程/推理内容")
