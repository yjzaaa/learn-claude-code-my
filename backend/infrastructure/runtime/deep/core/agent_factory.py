...
class AgentFactory:
    ...
    def build(context: AgentBuildContext) -> Any:
        ...
        try:
            ...
            if context.memory_config:
                builder.with_memory(
                    user_id=context.memory_config["user_id"],
                    project_path=context.memory_config.get("project_path", ""),
                    db_session_factory=context.memory_config["db_session_factory"],
                    auto_extract=context.memory_config.get("auto_extract", True),
                )
