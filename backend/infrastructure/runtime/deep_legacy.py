...
from .deep.services.config_adapter import DeepAgentConfig
from .deep.services.logging_mixin import DeepLoggingMixin
from langchain_anthropic import ChatAnthropic

# 导入新的灵活构建器
from .deep.agents import AgentBuilder, MiddlewareStack
...
class DeepAgentRuntime(AbstractAgentRuntime[DeepAgentConfig], DeepLoggingMixin):
    ...
    async def _ensure_agent_for_dialog(self, dialog_id: str) -> bool:
        ...
        try:
            ...
            # 重新构建 agent
            from .deep.agents import AgentBuilder
            base_prompt = self._config.system or self._config.system_prompt or ""
