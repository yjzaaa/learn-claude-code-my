...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, dialog_id: str | None = None):
        """接受连接"""
    ...
    def disconnect(self, websocket: WebSocket, dialog_id: str | None = None):
        """断开连接"""
...
class WebSocketServer:
    ...
    async def handle_client(self, websocket: WebSocket, dialog_id: str | None = None):
        """
        处理客户端连接
    ...
    async def _handle_message(
        self, websocket: WebSocket, message: dict[str, Any], dialog_id: str | None = None
    ):
        """处理客户端消息"""
    ...
    async def _on_event(self, event) -> None:
        ...
        # 广播到特定对话或全局
        dialog_id: str | None = getattr(event, "dialog_id", None)
        if dialog_id:
